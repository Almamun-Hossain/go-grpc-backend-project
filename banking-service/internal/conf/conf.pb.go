...
type Data struct {
	...
	UpstreamBank  *Data_UpstreamBank     `protobuf:"bytes,3,opt,name=upstream_bank,json=upstreamBank,proto3" json:"upstream_bank,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Data) GetUpstreamBank() *Data_UpstreamBank {
	if x != nil {
		return x.UpstreamBank
	}
	return nil
}
...
func (x *Data_UpstreamBank) Reset() {
	*x = Data_UpstreamBank{}
...
func (x *Data_UpstreamBank) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_UpstreamBank) ProtoMessage() {}

func (x *Data_UpstreamBank) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_UpstreamBank.ProtoReflect.Descriptor instead.
func (*Data_UpstreamBank) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{2, 2}
}

func (x *Data_UpstreamBank) GetBaseUrl() string {
	if x != nil {
		return x.BaseUrl
	}
	return ""
...
func (x *Data_UpstreamBank) GetApiKey() string {
	if x != nil {
		return x.ApiKey
	}
	return ""
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\rupstream_bank\x18\x03 \x01(\v2\x1d.kratos.api.Data.UpstreamBankR\fupstreamBank\x1a:\n" +
	"\bDatabase\x12\x16\n" +
	...
	"\fUpstreamBank\x12\x19\n" +
	"\bbase_url\x18\x01 \x01(\tR\abaseUrl\x12\x17\n" +
	"\aapi_key\x18\x02 \x01(\tR\x06apiKeyB$Z\"banking-service/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Data_UpstreamBank)(nil),   // 7: kratos.api.Data.UpstreamBank
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	7,  // 6: kratos.api.Data.upstream_bank:type_name -> kratos.api.Data.UpstreamBank
